...
ax1.bar(horas, corr_abr, width=1, edgecolor="white", linewidth=0.7, facecolor = "black" )
ax1.tick_params(axis='y', labelsize=15)
ax1.set_ylim(-0.5, 0.5)
ax1.set_yticks([-0.3, 0, 0.3]) 
ax1.xaxis.set_tick_params(labelsize=0, color='white')
ax1.text(0.5, 0.3, 'abril', fontsize=16)

ax2.bar(horas, corr_jul, width=1, edgecolor="white", linewidth=0.7, facecolor = "black" )
ax2.tick_params(axis='y', labelsize=15)
ax2.set_ylim(-0.5, 0.5)
ax2.set_yticks([-0.3, 0, 0.3]) 
ax2.xaxis.set_tick_params(labelsize=0, color='white')
ax2.text(0.5, 0.3, 'julio', fontsize=16)

ax3.bar(horas, corr_oct, width=1, edgecolor="white", linewidth=0.7, facecolor = "black" )
...
ax4.bar(horas, corr_dic, width=1, edgecolor="white", linewidth=0.7, facecolor = "black" )
ax4.tick_params(axis='y', labelsize=15)
ax4.tick_params(axis='x', labelsize=15,labelrotation = 90)
ax4.set_ylim(-0.5, 0.5)
ax4.set_yticks([-0.3, 0, 0.3]) 
ax4.text(0.5, 0.3, 'diciembre', fontsize=16)
